...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-900 via-black to-purple-900 text-white">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full p-4 bg-green-400 text-gray-900 rounded-lg shadow-lg hover:bg-green-300 transition"
          >
            Send Message
          </button>
        </form>
